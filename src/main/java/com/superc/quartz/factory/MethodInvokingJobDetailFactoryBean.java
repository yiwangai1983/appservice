package com.superc.quartz.factory;
...
public class MethodInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean
{
	...
	public void afterPropertiesSet() throws Exception
	{
      ...
      bw.setPropertyValue("name", beanName);
      bw.setPropertyValue("group", this.group);
      bw.setPropertyValue("jobClass", concurrent ? MethodInvokingJob.class : StatefulMethodInvokingJob.class);
      bw.setPropertyValue("durability", true);

			if(targetClass!=null)
			  ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("targetClass", targetClass);
			if(targetObject!=null)
			  ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("targetObject", targetObject);
			if(targetMethod!=null)
			  ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("targetMethod", targetMethod);
			if(staticMethod!=null)
			  ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("staticMethod", staticMethod);
			if(arguments!=null)
			  ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("arguments", arguments);
