...
public class BeanInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean, ApplicationContextAware
{
	...
	public void afterPropertiesSet() throws Exception
	{
      ...
      bw.setPropertyValue("jobClass", concurrent ? BeanInvokingJob.class : StatefulBeanInvokingJob.class);
      bw.setPropertyValue("durability", true);
      ((JobDataMap) bw.getPropertyValue("jobDataMap")).put("targetBean", targetBean);
